...
# Key Takeaways
1. The goal of time series clustering is the same as [[Clustering|traditional clustering]] with the restriction that point comparisons should be time-indexed and an entire series is the unit of analysis
